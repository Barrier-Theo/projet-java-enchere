...
<form class="form-modif text-center"
	...
	<h1 style="margin-top: 20px;"
		class="h3 mb-3 font-weight-normal marginbottom">Créer votre
		profil</h1>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-6">
				...
				<div class="form-group row">
					<label for="inputPrenom" class="col-sm-5 col-form-label">Prénom
						:</label>
					<div class="col-sm-7">
				...
				<div class="form-group row">
					<label for="inputTelephone" class="col-sm-5 col-form-label">Téléphone
						:</label>
					<div class="col-sm-7">
				...
				<div class="form-group row">
					<label for="inputMdp" class="col-sm-5 col-form-label">Mot
						de passe :</label>
					<div class="col-sm-7">
			...
			<div class="col-6">
				...
				<div class="form-group row">
					<label for="inputConfirm" class="col-sm-3 col-form-label">Confirmation
						:</label>
					<div class="col-sm-7">
			...
			<div class="offset-3 col-3">
				<a href="${pageContext.request.contextPath}" style="color: white;"
					class="btn btn-lg btn-danger btn-block margintop">Annuler</a>
			</div>
			<div class="col-3">
