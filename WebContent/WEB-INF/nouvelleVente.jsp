...
<div class="container">
	<div class="row">
		...
		<div class="col-12">
			...
			<form class="form-nouvelArticle"
				action="${pageContext.request.contextPath}/ServletNouvelArticleVendu"
				method="POST">
				<div class="row marginbottom">
								...
								<div class="form-group row">
									...
									<div class="col-sm-7">
										<input required type="number" class="form-control"
											name="prixDepartArticle">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-sm-5 col-form-label">Photo de
										l'article :</label>
									<div class="col-sm-7">
										<input type="file" class="form-control-file"
											name="cheminPhotoArticle">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-sm-5 col-form-label">Début de
										l'enchère :</label>
									<div class="col-sm-7">
										<input id="datepicker" required type="date"
											name="dateDebutArticle">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-sm-5 col-form-label">Fin de l'enchère
										:</label>
									<div class="col-sm-7">
					...
					<div class="col-6">
						...
						<div class="col-12 ">
							<img style="margin-bottom: 10px;" src="theme/images/article.png"
								align="center">
						</div>
								...
								<c:forEach items="${unUtilisateur}" var="utilisateur">
									...
									<div class="card-body">
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<input required class="form-control" name="rueArticle"
													value="${utilisateur.rue}">
											</div>
										</div>

										<div class="form-group row">
											<label class="col-sm-5 col-form-label ">&nbsp; Code
												Postal:</label>
											<div class="col-sm-7">
												<input required class="form-control"
													name="codePostalArticle" value="${utilisateur.codePostal}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<input required class="form-control" name="villeArticle"
