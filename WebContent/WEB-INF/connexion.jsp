...
<%@include file="fragments/Head.jsp"%>
    ...
    <form class="form-signin connexion text-center" action="${pageContext.request.contextPath}/ServletConnexionUtilisateur" method="POST">
		...
		<a href="${pageContext.request.contextPath}/ServletAccueil" style="color:white;" class="btn btn-lg btn-secondary btn-block margintop marginbottom">Voir les enchères</a>
